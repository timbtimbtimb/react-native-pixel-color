...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text>Duration: {(time / 1000).toFixed(3)} sec.</Text>
      <View
        style={{
          ...styles.color,
      ...
      />
      <View>
        <Text>r: {color.red}</Text>
        <Text>g: {color.green}</Text>
        <Text>b: {color.blue}</Text>
        <Text>a: {color.alpha}</Text>
      </View>
    </View>
  );
}
